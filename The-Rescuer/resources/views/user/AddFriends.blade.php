...
<body>
    ...
    <section class="SignUp-section">
        ...
        <form class="col-lg-5 col-md-7 col-sm-8 col-10 shadow p-5 text-center" id="SIgnup-design" method="POST"
         action="{{url('SubmitFriends')}}" enctype="multipart/form-data">
            @csrf
            ...
            @endif
            <p style="font-weight: 900; font-size: 40px; color: rgb(173, 37, 27);"> Add Friends</p>
            <br>
            ...
            <button type="submit" name="submitButton" class="btn my-2 py-2" id="button-login">Add Friends</button>
